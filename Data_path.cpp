...
{
    regRead = regWrite = ALUSrc = memRead = memWrite = mem2reg = branch = Jump = 0;
    ALUOp = "00";
    ALUSelect = "0000";
}
...
int getimm(string ins)
{
    ...
    if (opcode == "0100011")
    {
        // string str = ins.substr(0,7) + ins.substr(20,5);
        // cout << str << endl;
...
int main()
{
    ...
    freopen("input_single_cycle.txt", "r", stdin);
    for (int i = 0; i < 32; i++)
    {
        GPR[i] = 0;
    }
